...
The experiments show that SAMBL is *more sample efficient*, especially in high dimensions. 
It attains lower regret than the dense OLS baseline as the dimension grows, on synthetic systems and on two structured benchmarks (a spring-mass chain and the IEEE 39-bus power grid).
